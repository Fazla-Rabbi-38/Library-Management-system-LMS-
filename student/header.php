...
if (!isset($_SESSION['student_login'])) {
 ...
 $data=mysqli_query($con,"SELECT * FROM students WHERE username='$student_login' ");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= $student_info['full_name']?><br>
                ...
                <div id="left-nav" class="nano">
                    <div class="nano-content">
                        <nav>
                            ...
                            <li class="<?= $page =='test.php'? 'active-item' : '' ?> "><a href="manage_books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a></li>
                                
                             <li class="<?= $page =='test.php'? 'active-item' : '' ?> "><a href="test.php"><i class="fa fa-phone" aria-hidden="true"></i><span>Contact To Librarian</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
