...
if (!isset($_SESSION['librarian_login'])) {
 ...
 $data=mysqli_query($con,"SELECT * FROM librarian WHERE username='$librarian_login' ");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= $librarian_info['full_name']?></span>
                ...
                <div id="left-nav" class="nano">
                    <div class="nano-content">
                        <nav>
                            ...
                            <!--TABLES-->
                                <li class="has-child-item close-item <?= $page == 'manage_books.php' ? 'open-item':'' ?>
                                <?= $page == 'add_books.php' ? 'open-item':'' ?>">
                                    <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li class="<?= $page == 'add_books.php' ? 'active-item':'' ?>"><a href="add_books.php">Add Books</a></li>
                                ...
                                <li class="<?= $page =='issue_book.php' ? 'active-item' : '' ?>"><a href="return_book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Book</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
